...
namespace LojaVirtual.Controllers
{
    ...
    /* Mapeia as requisi��es de http://localhost:{porta}/api/persons/v1/
    Por padr�o o ASP.NET Core mapeia todas as classes que extendem Controller
    pegando a primeira parte do nome da classe em lower case [substance]Controller
    e exp�e como endpoint REST
    */
    [ApiVersion("1")]
    [Route("api/[controller]/v{version:apiVersion}")]
    public class SubstanceController : Controller
    {
        //Declara��o do servi�o usado
        private ISubstanceBusiness _substanceBusiness;

        /* Inje��o de uma instancia de ISubstanceBusiness ao criar
        ...
        // Configura o Swagger para a opera��o
        ...
        // O [SwaggerResponse(XYZ)] define os c�digos de retorno 204, 400 e 401
        [HttpGet]
       ...
       // [Authorize("Bearer")] ACIONAR DEPOIS JWT
        ...
        // [SwaggerResponse((202), Type = typeof(substance))]
        // determina o objeto de retorno em caso de sucesso substance
        // O [SwaggerResponse(XYZ)] define os c�digos de retorno 400 e 401
        [HttpPost]
